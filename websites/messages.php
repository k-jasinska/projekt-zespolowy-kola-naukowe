	...
	<div class="content">
		<div class="row mx-auto col-sm-12 col-md-12 col-lg-12 col-xl-12">
					...
					<div class="container mt-3 background msg-menu">
						<ul class="list-group navbar-nav">
							<li class="list-group-item msg-menu-item">
								<a class="nav-link" href="#">Wyślij</a>
							</li>
							<li class="list-group-item msg-menu-item">
					...
					<div class="container mt-3 background search-div">
						...
						<div class="checkbox form-group form-check">
							<label class="form-check-label">
								<input class="form-check-input" type="checkbox" name="groups"> Tylko moje koła
							</label>
						</div>
			...
			<div class="col-lg-8 col-md-8 col-sm-6">
				<div class="right-part background msg-form mx-auto">
					<form method="POST" id="msg-form">
					<h2>Utwórz wiadomość</h2>
						<div class="form-group">
							<label for="nick">Nick adresata:</label>
							<input type="text" class="form-control form-input" id="nick" name="nick">
						</div>
						<div class="form-group">
							<label for="title">Temat:</label>
							<input type="text" class="form-control form-input" maxlength="100" id="title" name="title">
						</div>
						<div class="form-group">
							<label for="nick">Wiadomość:</label>
